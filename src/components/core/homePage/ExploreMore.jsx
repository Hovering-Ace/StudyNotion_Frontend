...
const ExploreMore = () => {
  ...
  return (
    <div>
      ...
      {/* Tabs Section */}
      <div className="hidden lg:flex gap-5 -mt-5 mx-auto mb-16 w-max bg-richblack-800 text-richblack-200 p-1 rounded-full font-medium drop-shadow-[0_1.5px_rgba(255,255,255,0.25)]">
